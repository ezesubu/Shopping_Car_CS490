 ...
 **/
@Controller
@RequestMapping("/superadmin/product")
public class SuperAdminProductController {
    ...
    @Autowired
    public SuperAdminProductController(IProductService productService, ICategoryService categoryService) {
    ...
    public String getProduct(@RequestParam(required = false) String name,
        ...
        return "/superadmin/product/list";
    }
