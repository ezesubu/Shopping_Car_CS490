...
<script type="text/javascript">
    ...
    module = {
        list : function(page){
            ...
            $.get('${pageContext.request.contextPath}/admin/user/customer/list?page=' + page, $("#filterForm").serialize(), function(data){
        ...
        edit : function(id){
            ...
            $.get('${pageContext.request.contextPath}/admin/user/customer/edit', 'id='+id, function(data){
