...
<div class="container">
    <div class="main">
        <h1 class="page-header">Manage Vendors</h1>
        <div class="clearfix">
...
<script type="text/javascript">
    ...
    module = {
        list : function(page){
            ...
            $.get('${pageContext.request.contextPath}/admin/user/vendor/list?page=' + page, $("#filterForm").serialize(), function(data){
        ...
        edit : function(id){
            ...
            $.get('${pageContext.request.contextPath}/admin/user/vendor/edit', 'id='+id, function(data){
