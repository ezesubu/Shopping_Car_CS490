...
<%--                                    <c:forEach items="${categories}" var="category" begin="0" end="2">--%>
<%--                                        <img style="object-fit: cover;" src="${pageContext.request.contextPath}${resourcePath}${category.image}" alt="img">--%>
<%--                                        <div class="aa-prom-content">--%>
<%--                                            <h4 style="color: #3fc35f;  text-shadow: 2px 2px #000;"><a style="color: #3fc35f !important;" href="${pageContext.request.contextPath}/product/search?categoryId=${category.id}">${category.name}</a></h4>--%>
<%--                                        </div>--%>
<%--                                    </c:forEach>--%>
<%--                                </div>--%>
<%--                            </div>--%>
